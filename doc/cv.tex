...
C. Sanford, D. Hsu, M. Telgarsky. ``Representational strengths and limitations of transformers.'' \textit{Appearing at Neural Informational Processing Systems (NeurIPS) 2023.}
...
% \begin{itemize}
    \item ICLR (2024), ALT (2024), JMLR (2023), NeurIPS (2023), ICLR climate workshop (2023), SODA (2022), STOC (2022).
% \end{itemize}
\end{rSubsection}
